	...
	<div id = "menu">
		<?php
			...
			while($row = mysqli_fetch_array($result)){
				 ...
				 echo "<li><a href = 'Intermedite_change_view.php?user=$username&role=$roles1'><button id = '".$b."'class = '".$a."' name = 'roleSelected'>".$row['username']."</button></a>";
				 ...
				 while($rows = mysqli_fetch_array($result2)){
				 	...
				 	echo "<li><a href = 'Intermedite_change_view.php?user=$username2&role=$roles2'><button id = '".$b."' class = '".$a."' name = 'roleSelected'>".$rows['username']."</button></a></li>";
				 }
				 echo "</ul>";
				 echo "</li>";
			}
